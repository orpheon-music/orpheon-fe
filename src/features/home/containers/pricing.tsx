...
export default function Pricing() {
    ...
    return (
        <div
            id="pricing"
            ref={sectionRef}
            className="min-h-screen bg-black text-white py-20 md:py-52 px-4"
        >
            <div className="max-w-6xl mx-auto">
                {/* Header */}
                <div className='flex justify-center items-center flex-col gap-8'>
                    <div className='flex gap-2 items-center py-2 px-4 border border-white pricing-header'>
                ...
                <div className="grid gap-8 md:grid-cols-3 md:gap-6 lg:gap-8 container mt-20">
                    {plans.map((plan, index) => (
                        <Card
                            key={plan.name}
                            className={cn(
                                "relative rounded-3xl pricing-card",
                                plan.popular
                        ...
                        >
                            <CardHeader className="text-center pb-8">
                                ...
                                <CardDescription className={`text-sm leading-relaxed ${plan.popular ? "text-purple-100" : "text-[#767B7E]"}`}>
                                    {plan.description}
                                </CardDescription>
                            </CardHeader>
